...
if($taskID===false)
    ...
    var_dump($taskID);
*/
//$taskID=$dj->addTask("export", "mysql", "dy2", "dep_sentence.sql.zip", "app_semanticannotate", "dep_sentence", "");
$taskID=$dj->addTask("export", "mysql", "semantic", "dependancy.sql.zip", "app_semanticannotate", "dependancy", "");

//$taskID=$dj->addTask("export", "mysql", "dy2", "fillout.sql.zip", "app_semanticannotate", "fillout", "");
//$taskID=$dj->addTask("export", "mysql", "dy2", "sentence.sql.zip", "app_semanticannotate", "sentence", "");
if($taskID===false)
   var_dump($dj->errno(), $dj->errmsg());
...
{
    private $_accesskey = "jm0z0kmn1l";
    private $_secretkey = "l4ywjmzjmxz1wm3my53zz41z5121mzz14k0x22ii";
