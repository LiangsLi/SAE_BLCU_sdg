	...
	$("#search").click(function(){
		...
		$.post(
			...
			function (data){
				...
				document.getElementById('table-quality').innerHTML = "共<b> " + (recordlen/4) + " </b>条记录&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;左键可以修改句子！多次查找，请先刷新页面再查找";
...
<body oncontextmenu=self.event.returnValue=false>
	...
	<button id="search" type="button" class="save">search</button><p>关键字之间用空格分开；搜索结果按时间从前到后排序，保证你最新改过的句子会排在搜索结果的后面；多次搜索之间要刷新页面再搜索，否则结果显示会错乱。可以对于搜索列表依次点击进行修改，然后再进行下一次搜索。</p>
